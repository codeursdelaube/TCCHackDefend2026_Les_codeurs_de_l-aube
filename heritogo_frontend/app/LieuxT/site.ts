...
export const monuments: Monument[] = [
  ...
  },
  {
    ...
    "région": "Maritime",
    "localite": "Agbodranfo",
    "description": "Un haut lieu de mémoire poignant situé à Agbodranfo, témoin historique du commerce négrier.",
    "histoire": "Située à Agbodranfo, une ancienne cité portugaise reconnue comme faisant partie intégrante de la 'Côte des esclaves', la maison des esclaves (Woold Home) ainsi que le puits des enchaînés constituent les vestiges majeurs de ce passé douloureux où l'émotion reste toujours vive.",
    "lat": 6.2053,
    "lng": 1.4786,
    "image": Im6
  },
