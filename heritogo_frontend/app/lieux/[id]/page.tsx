  ...
  return (
    <main className="relative min-h-screen w-full bg-base-100 text-base-content
      ...
      <div className="absolute top-1/3 left-1/4 w-125 h-125
                      bg-green-500/5 blur-[130px] rounded-full pointer-events-none" />
      ...
      <div className="relative z-10 container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12
          ...
          <div className="relative w-full h-80 sm:h-112.5 md:h-125
            ...
            />
            {/* Overlay image — toujours sombre car sur photo */}
            <div className="absolute inset-0 bg-linear-to-t
                            from-black/40 via-transparent to-transparent" />

            {/* Badge région */}
            <span className="absolute top-4 left-4 badge bg-green-600
                             border-none text-white font-bold text-xs
                             tracking-wider uppercase px-3 py-2
          ...
          <div className="flex flex-col justify-between h-full space-y-6 lg:pt-2">
            <div>
              ...
              <div className="space-y-3">
                <h2 className="text-lg font-black text-green-500 uppercase
            ...
            <div className="pt-6 border-t border-base-content/5 mt-auto
              ...
              <div className="text-xs text-base-content/40 font-medium
                ...
                <span>
                  Coordonnées GPS :{' '}
                  <span className="font-mono bg-base-300
                                   text-base-content/70
                                   border border-base-content/10
                                   px-2 py-1 rounded-md ml-1">
